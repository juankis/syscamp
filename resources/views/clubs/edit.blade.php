...
<div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="col-md-6 col-sm-6 col-xs-6">
        <div class="form-group">
          ...
          <div class="col-sm-9 prepend-icon">
            <input type="text" name="id_club" value='{{$club->id_club}}' class="form-control" placeholder="Minimo 3 caracteres ..." minlength="3" required>
            <i class="icon-user"></i>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 prepend-icon">
            <input type="number" name="fijo" value='{{$club->fijo}}' class="form-control" placeholder="Minimo 3 caracteres ..." minlength="3" >
            <i class="icon-user"></i>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-9 prepend-icon">
            <input type="number" name="movil" value='{{$club->movil}}' class="form-control" placeholder="Minimo 3 caracteres ..." minlength="3" required>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 prepend-icon">
            <input type="text" name="facebook" value='{{$club->facebook}}' class="form-control" placeholder="Minimo 3 caracteres ..." minlength="3" required>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9 prepend-icon">
            <input type="text" name="dt_name" value='{{$club->dt_name}}' class="form-control" placeholder="Minimo 3 caracteres ..." minlength="3" required>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-9 prepend-icon">
            <input type="text" name="dt_second_name" value='{{$club->dt_second_name}}' class="form-control" placeholder="Minimo 3 caracteres ..." minlength="3" required>
          </div>
        </div>
      <div class="form-group">
