            ...
            <ul class="header-menu nav navbar-nav">
              ...
              <li class="dropdown" id="language-header">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="#" data-lang="en"><img src="<?php echo e(asset('images/flags/usa.png')); ?>" alt="flag-english"> <span>English</span></a>
                  </li>
                  <li>
                    <a href="#" data-lang="es"><img src="<?php echo e(asset('images/flags/spanish.png')); ?>" alt="flag-english"> <span>Español</span></a>
                  </li>
                  <li>
                    <a href="#" data-lang="fr"><img src="<?php echo e(asset('images/flags/french.png')); ?>" alt="flag-english"> <span>Français</span></a>
                  </li>
                </ul>
              </li>
              <END USER DROPDOWN -->
                  ...
                  <li class="dropdown-body">
                    <ul class="dropdown-menu-list withScroll" data-height="220">
                      <li class="clearfix">
                        ...
                        <img src="<?php echo e(asset('images/avatars/avatar3.png')); ?>" alt="avatar 3">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="<?php echo e(asset('images/avatars/avatar4.png')); ?>" alt="avatar 4">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="<?php echo e(asset('images/avatars/avatar5.png')); ?>" alt="avatar 5">
                        </span>
                        <div class="clearfix">
                          <div>
                      ...
                      <li class="clearfix">
                        <span class="pull-left p-r-5">
                        <img src="<?php echo e(asset('images/avatars/avatar6.png')); ?>" alt="avatar 6">
                        </span>
                        <div class="clearfix">
                          <div>
              ...
              <li class="dropdown" id="user-header">
                <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                <img src="<?php echo e(asset('images/avatars/user1.png')); ?>" alt="user image">
                <span class="username">Hola, juan</span>
                </a>
                <ul class="dropdown-menu">
                  <li>
